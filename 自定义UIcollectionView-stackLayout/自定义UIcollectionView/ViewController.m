...
- (void)viewDidLoad {
    ...
    UICollectionView *collectionView = [[UICollectionView alloc]initWithFrame:rec collectionViewLayout:[[StackLayout alloc]init]];
...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    {
        [self.collectionView setCollectionViewLayout:[[StackLayout alloc]init]];
    }
